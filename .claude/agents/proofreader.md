...
### 3. OVERFLOW
- Content likely to exceed slide boundaries. Look for: too many bullet points, inline font-size overrides below 0.85em, dense slides that should be split.
...
Save to `quality_reports/[DECK]_qmd_report.md`
