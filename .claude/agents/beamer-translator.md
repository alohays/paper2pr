...
1. **Is it a TikZ diagram?** → Reference extracted SVG: `![](../Figures/PaperName/tikz_exact_XX.svg){fig-align="center"}`
...
2. Reference: `![](../Figures/PaperName/file.svg){fig-align="center"}`
