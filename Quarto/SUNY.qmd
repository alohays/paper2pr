...
::: {style="text-align: center;"}
[**$245,000**]{.hi}   US avg total comp for AI engineers.
...
[$On pace to surpass all of 2024 ($6.1B full year).]{.neutral}
:::
...
<video src="https://raw.githubusercontent.com/worv-ai/worv-ai.github.io/main/canvas/static/videos/orchard_canvas.mp4"
       autoplay loop muted playsinline width="75%"
       style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
<div class="video-label">Autonomous orchard navigation via hand-drawn sketch</div>

::: {.smaller}
- [**InternVL**]{.hi} backbone: [**2× faster**]{.hi} inference · pipeline [**40--60×**]{.hi} faster · [**9 releases**]{.hi} (v0.1.0 → v0.2.5)
- Source: CANVAS, ICRA 2025 (arXiv:2410.01273)
:::
...
<video src="https://raw.githubusercontent.com/worv-ai/worv-ai.github.io/main/d2e/static/videos/libero-1-ptft.mp4"
       autoplay loop muted playsinline width="65%"
       style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
<div class="video-label">Robot manipulation learned from 1,300h of game recordings (LIBERO)</div>

::: {.smaller}
- [**96.6%**]{.positive} on LIBERO · beats models up to [**7× larger**]{.hi} ($\pi_0$ 3.3B, OpenVLA 7B) · [**ICLR 2026 top 10%**]{.hi}
:::
...
:::: {.columns}
::: {.column width="52%"}
![](../Figures/SUNY/canvas_deployment.png){fig-align="center" width="55%"}

::: {.footnote}
CANVAS deployment: comparing navigation methods across real-world scenarios (Street, Orchard)
:::
:::
::: {.column width="45%"}
1. [**Simulation research**]{.hi} --- 29% → 50%
2. [**Lab prototype**]{.hi} --- 87.5% with 2.5h real data
3. [**Field evaluation**]{.hi} --- 4 evals in 8 days
4. [**Final result**]{.positive} --- [**97.3% success**]{.hi}, [**0% failure**]{.positive}
5. [**Commercial**]{.positive} --- [**100+ contracts**]{.hi}, Korea + Japan
...
::: {.keybox style="text-align: center;"}
But knowing the tools is table stakes. The real career edge in 2026? **Orchestrating** them.
:::
...
| Uses AI tools individually | [**Orchestrates multi-agent workflows**]{.positive} |

::: {.keybox style="text-align: center; margin-top: 1em;"}
[**AI writes the code.   You orchestrate the system.   You own the understanding.**]{.hi}
:::


<!-- New Slides 45-47: Agent Orchestration -->


## From AI User to AI Architect

**[Level 1]{.hi} --- AI User:** Use ChatGPT/Claude for individual tasks [(where most students start)]{.neutral}

**[Level 2]{.hi} --- AI Builder:** Build with Cursor/Copilot, deploy AI-powered features [(Slide 40 projects)]{.neutral}

**[Level 3]{.hi} --- AI Architect:** Design multi-agent systems, orchestrate AI workflows [(the new frontier)]{.neutral}

::: {.highlightbox}
Workers in AI-exposed roles earn a **56% wage premium**

Skills in AI-exposed roles evolve **66% faster**

[PwC Global AI Jobs Barometer, 2025]{.neutral}
:::

::: {.keybox style="text-align: center;"}
Level 3 is where the hiring premium lives --- and where the fewest candidates are.
:::


## What AI Agent Orchestration Actually Looks Like {.smaller}

Multi-agent = multiple AI models collaborating on one task

| [**2024: AI Tool User**]{.neutral} | [**2026: AI System Architect**]{.hi} |
|---|---|
| One prompt → one answer | [**Pipeline: plan → code → review → deploy**]{.positive} |
| Copy-paste between tools | [**Agents hand off work automatically**]{.positive} |
| You manage the workflow | [**The system manages itself**]{.positive} |

::: {.methodbox}
**Who's Hiring for This**

- OpenAI --- Agent Infrastructure Engineers
- Google --- 40% of enterprise apps will use AI agents by 2026 [Gartner, 2025]{.neutral}
- Anthropic --- Claude Code multi-agent teams
- GenAI job postings grew **170%** in one year [Indeed Hiring Lab, 2025]{.neutral}
:::


## Build an Agent Portfolio Project

These are Level 3 projects --- beyond Slide 40. They show you can **orchestrate**, not just use.

1. **Multi-Agent Code Reviewer** --- 3 AI agents (style, bugs, security) review code together. Tools: Claude Code + scripting. *Weekend project.*
2. **Research Assistant Pipeline** --- Chain: search papers → summarize → compare → synthesize. Tools: Claude API + LangGraph. *2-week project.*
3. **AI Debate Team** --- Agents with different expertise argue a topic, then reach consensus. Tools: CrewAI or Claude teams. *2-week project.*

::: {.keybox style="text-align: center;"}
The students who can orchestrate AI agents will be the ones companies fight over in 2027.
:::
...
| [**$245K**]{.hi} avg AI engineer salary (US) | [**50% of positions unfilled**]{.hi-gold} |
|---|---|
...
|---|---|
| [**AI Tools & Orchestration**]{.hi-gold style="font-size: 1.2em;"} | Claude, Cursor, agent workflows --- the new career edge. |
