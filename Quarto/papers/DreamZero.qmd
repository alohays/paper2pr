...
format:
  revealjs:
    theme: [default, ../clean-academic-legacy.scss]
    slide-number: true
    chalkboard: false
    preview-links: auto
    width: 1280
...
![](../../Figures/papers/DreamZero/dreamzero-header-v2.svg){fig-align="center" width="85%"}
:::

<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_post_train/hsl/DreamZero_AgiBotPostTrain_FruitPacking_2x.m3u8" data-autoplay loop muted playsinline width="60%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
...
[--- Jim Fan, *The Second Pre-training Paradigm* [@fan2026secondparadigm]]{style="display: block; text-align: right;"}
...
[--- Joel Jang, *World Models for Robotics* [@jang2026worldmodels]]{style="display: block; text-align: right;"}
...
![](../../Figures/papers/DreamZero/eval_bar_chart.svg){fig-align="center" width="75%"}
...
- "Generating pixels is the only way for humans to *verify* that the model truly understands" --- Joel Jang [@jang2026worldmodels]
...
![](../../Figures/papers/DreamZero/dreamzero_model.svg){fig-align="center" width="88%"}
...
![](../../Figures/papers/DreamZero/bidiraug.svg){fig-align="center" width="100%"}
:::
...
::: {.softbox}
[**Commentary:**]{.hi-gold} AR wins on both quality AND speed --- KV-cache gives $3$--$4\times$ speedup (bidirectional cannot cache), and native frame rate preserves the temporal signal the IDM needs.
:::
...
![](../../Figures/papers/DreamZero/dreamzero_attention_figure.svg){fig-align="center" width="78%"}
...
![](../../Figures/papers/DreamZero/dreamzero-flash_noise_distribution_comparison.svg){fig-align="center" width="60%"}
...
::: {.column width="46%"}
![](../../Figures/papers/DreamZero/agibot_dc_envs.svg){fig-align="center" width="100%"}
...
::: {.column width="46%"}
![](../../Figures/papers/DreamZero/agibot_stats_3.svg){fig-align="center" width="100%"}
...
![](../../Figures/papers/DreamZero/main_eval_setting.svg){fig-align="center" width="80%"}
...
![](../../Figures/papers/DreamZero/eval_bar_chart.svg){fig-align="center" width="78%"}
...
![](../../Figures/papers/DreamZero/unseen_success_rates.svg){fig-align="center" width="78%"}
...
:::: {.columns}
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_unseen/hsl/NEWUNSEEN_006_02.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Untie Shoelace (Unseen)]{.video-label}
:::
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_unseen/hsl/NEWUNSEEN_057.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Shake Hands (Unseen)]{.video-label}
:::
::::
...
![](../../Figures/papers/DreamZero/dreamzero_gen.svg){fig-align="center" width="85%"}
...
:::: {.columns}
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_seen/hsl/SEENASYNC_001_AI.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[AI Prediction]{.video-label}
:::
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_seen/hsl/SEENASYNC_001.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Real Execution]{.video-label}
:::
::::
...
![](../../Figures/papers/DreamZero/posttrain.svg){fig-align="center" width="78%"}
...
![](../../Figures/papers/DreamZero/embodiment_transfer.svg){fig-align="center" width="75%"}
...
:::: {.columns}
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/droid/hsl/toast_bread%20(AI).m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[DROID: AI Prediction]{.video-label}
:::
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/droid/hsl/toast_bread%20(real).m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[DROID: Real Execution]{.video-label}
:::
::::

::: {.softbox}
[**Commentary:**]{.hi-gold} Video-only data (no action labels!) opens a [**massive scaling pathway**]{.hi}. YouTube hosts [**>800M hours**]{.positive} of how-to video --- the bottleneck shifts from "collect robot data" to "build a better IDM".
:::
...
![](../../Figures/papers/DreamZero/yam_transfer.svg){fig-align="center" width="82%"}
...
:::: {.columns}
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/yam/hsl/1_teddy.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Pick Teddy Bear]{.video-label}
:::
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/yam/hsl/2_orange.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Orange to Pumpkin]{.video-label}
:::
::::
...
![](../../Figures/papers/DreamZero/free_form.svg){fig-align="center" width="85%"}
...
:::: {.columns}
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_interactive_prompting/hsl/Water_the_plant.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Water Plant]{.video-label}
:::
::: {.column width="48%"}
<video data-hls="https://dreamzero0.github.io/labs/gear/videos/agi_interactive_prompting/hsl/Open_the_door.m3u8" data-autoplay loop muted playsinline width="100%" style="display: block; margin: 0 auto; border-radius: 6px;">
</video>
[Open Door]{.video-label}
:::
::::
...
## Task Diversity: 103 Tasks Across 22 Environments

:::: {.columns}
::: {.column width="48%"}
[**Seen Tasks (10 evaluated):**]{.hi}

![](../../Figures/papers/DreamZero/agibot_seen_example.svg){fig-align="center" width="100%"}

[take, place, push, open, pour]{style="font-size: 0.85em;"}
:::

::: {.column width="48%"}
[**Unseen Tasks (10 evaluated):**]{.hi}

![](../../Figures/papers/DreamZero/agibot_unseen_example.svg){fig-align="center" width="100%"}

[iron, untie, shake hands, remove hat]{style="font-size: 0.85em;"}
:::
::::
...
::: {.softbox}
[**Commentary:**]{.hi-gold} A [**fundamental architectural difference**]{.hi}, not data/compute. VLMs encode semantics; video models encode physics. For robotics, physics wins. Expect hybrid approaches combining VLM semantics with WAM physics.
:::
...
![](../../Figures/papers/DreamZero/generated.svg){fig-align="center" width="75%"}

[**Error causal chain:**]{.hi} Video backbone hallucinates $\rightarrow$ wrong predicted frames $\rightarrow$ IDM extracts actions from wrong video $\rightarrow$ robot executes incorrect motion
...
- [**Quantization:**]{.hi} NVFP4 (weights), FP8 (QKV/Softmax), FP16 (non-linear)
...
<!-- Slide 31b: WAM as Modified Video DiT -->


## Code: WAM as Modified Video DiT

::: {.methodbox}
**Core Architecture**

- Core file: `wan_video_dit_action_causal_chunk.py`
- Action head integrated [**INTO**]{.hi} diffusion process (not a separate MLP)
- Flow matching scheduler + [**UniPC multi-step**]{.hi} for Flash mode
- Codebase: `groot/vla/model/dreamzero/`
:::

::: {.softbox}
[**Commentary (from code):**]{.hi-gold} DreamZero is not "video model + action decoder" --- it is a [**single DiT**]{.hi} that jointly denoises both modalities.
:::
...
2. Context window: [**6.6 seconds**]{.negative}
3. Still [**7Hz**]{.negative} vs. 20Hz+ for VLAs
4. [**Sub-centimeter precision**]{.negative} limits
...
- $2 \times \text{GB200}$ GPUs for real-time
...
- Comparison with other WAMs (Cosmos Policy, UVAM) on same benchmarks
...
::: {.softbox}
[**Commentary:**]{.hi-gold} Current zero-shot is "AI Slop" phase [@jang2026worldmodels] --- correct direction, but [**not deployment-ready**]{.hi} yet.
:::
...
## What DreamZero Means for the Field
...
5. Video backbone quality = policy quality $\rightarrow$ "chain of thought in [**visual space**]{.hi}"
:::
...
- Joel Jang [@jang2026worldmodels]
- Jim Fan [@fan2026secondparadigm]
:::
