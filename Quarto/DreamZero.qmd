...
::: {.softbox}
[**My Take:**]{.hi-gold} "Language is a bottleneck, a scaffold, not a foundation" for physical intelligence.
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} The fundamental gap --- VLMs encode "[**what**]{.hi} to do" but not "[**how**]{.hi} to move".
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} This is the core paradigm shift --- from discrete task policies to [**continuous world modeling**]{.hi}.
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} This is the sleeper insight --- human video as the ultimate robot training data.
:::
...
<!-- Slide 9b: AR — My Take -->
## AR vs. Bidirectional: My Take

::: {.softbox}
[**My Take:**]{.hi-gold} AR wins on both quality AND speed --- a rare "have your cake and eat it too" situation.
:::
...
## Ground-Truth Injection: My Take

::: {.softbox}
[**My Take:**]{.hi-gold} WAMs [**self-correct via reality**]{.hi}. No other paradigm gets this for free.
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} The key result --- DreamZero does things it was [**NEVER trained to do**]{.hi}.
:::
...
## Cross-Embodiment Transfer: My Take

::: {.softbox}
[**My Take:**]{.hi-gold} Video-only data (no action labels!) opens a [**massive scaling pathway**]{.hi}. Human video is orders of magnitude more abundant than robot data.
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} A [**fundamental architectural difference**]{.hi}, not data/compute. VLMs encode semantics; video models encode physics. For robotics, physics wins.
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} The tight coupling is both strength and weakness --- [**video quality is the bottleneck**]{.hi}.
:::
...
::: {.softbox}
[**My Take (from code):**]{.hi-gold} Each robot gets its own "translator" while sharing the world model.
:::
...
::: {.softbox}
[**My Take (from code):**]{.hi-gold} Far beyond typical research code --- production-grade systems engineering.
:::
...
::: {.softbox}
[**My Take (from code):**]{.hi-gold} Data infrastructure is as important as the model architecture.
:::
...
::: {.softbox}
[**My Take:**]{.hi-gold} Current zero-shot is "AI Slop" phase (Joel Jang) --- correct direction, but [**not deployment-ready**]{.hi} yet.
:::
