# DGIST W04 Research and Instructor Study Plan

**Lecture:** Foundations of Robot Hardware, Control, and Modern Platforms  
**Session:** DGIST HSS118 W04, September 18, 2026, 13:00-14:00  
...
- W03 is the guest session "Video and Robot Foundation Models." W04 must connect to it using only its published title and already established course concepts, not a post-session summary or late deck patch.
- W04 is the physical-stack bridge to W06 on action data and W09 on learning methods. It must not re-teach VLA history, data scaling, imitation learning, reinforcement learning, or diffusion policies.
...
- Course materials are due September 11, 2026.
...
9. Treat software only as a hardware-control interface axis: command and state access, update rate, latency and jitter, low-level permissions, logging, reset and recovery, simulation support, and safety isolation. Do not turn W04 into a ROS 2 or simulator ecosystem lecture.
...
- a complete study-site freeze before instructor study, followed by lecture planning and deck production before the September 11 handoff.

## 1. Communication and learning jobs

### Lecture communication job

By the end of W04, non-major first- and second-year students should be able to trace how an AI or human command becomes physical work, because they can separate embodiment, actuation, sensing, feedback control, policy or operator, and contact, and can explain why the best robot body depends on the task.
...
`/Users/iyunseong/Documents/vault/1-projects/maum/dgist-future-literacy-2026fall/lectures/w04-robot-hardware/study-note/`
...
| 7. Teach it, question it | 15 min | What belongs in W04, what belongs only in Q&A, and what must be deferred? | Oral mastery checks and anticipated Q&A |
...
| Sep 1 | Source spine and parallel research launch | Ledgers, glossary, task set, module skeleton, candidate landscape, and independent work packets exist |
| Sep 2 | Mechanics, actuation, and control draft | Modules 0-3 and simulations A and B pass first source and sanity review |
| Sep 3 | Embodiment, history, platform, and deployment draft | Modules 4-7, four provisional deep cases, simulation C, and evidence cards are complete |
| Sep 4 | Full study-site integration | Every core module, visual, interaction, citation, and local asset is present |
| Sep 5 | Site QA and v1 freeze | Visual, functional, source, privacy, accessibility, and no-network checks pass |
| Sep 6 | Instructor study pass | Instructor completes the 3-4 hour core and records unclear points and Q&A gaps |
| Sep 7 | Gap repair and mastery gate | Study-site corrections land and instructor passes the mastery checks below |
| Sep 8 | Lecture communication plan | W04 thesis, learning outcomes, section timing, cases, and exclusions are decided |
| Sep 9 | Deck authoring | The Quarto deck and required public visual and media assets reach a complete first version |
| Sep 10 | Deck verification | Render, visual audit, fact check, timing pass, and quality gate reach at least 80, targeting 90 |
| Sep 11 | Administrative handoff | Course material is sent to the TA and administrator; W03 callback remains title-based |

Schedule warning: one authoring day and one verification day are still aggressive for a normal 40-60 slide cycle. Research and site work therefore need independent parallel work packets from September 1, and deck-ready public visuals should be identified during WS8 even though slide composition cannot begin before the September 7 mastery gate. If execution starts late, freeze the site scope at the core modules and postpone optional appendices; do not weaken evidence checks or start an incomplete site study pass.
...
- W03 callback wording can be supported from the public title and existing course concepts;
- W06 and W09 boundaries remain intact.
...
| Site must be complete before study, delaying feedback | Core site misses Sep 4 integration | Cut optional appendices immediately; preserve full core and QA |
| Deck schedule becomes unsafe | Mastery gate slips past Sep 7 | Escalate schedule risk and negotiate the handoff, rather than ship unverified content |
