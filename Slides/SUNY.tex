...
\begin{axis}[
  ...
  \node[font=\tiny, text=negativered, align=center] at (axis cs:2nd eval, 95) {eval set\\changed};
\end{axis}
\end{tikzpicture}
\end{center}
\vspace{0.2em}
...
\vspace{0.1em}
\begin{center}
  \includegraphics[width=0.80\textwidth, height=0.52\textheight, keepaspectratio]{../Figures/SUNY/d2e_teaser.png}
\end{center}
\vspace{0.2em}
